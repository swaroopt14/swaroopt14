                      ...
                      return (
                        <div key={row.label} className="group relative flex h-full flex-1 flex-col items-center justify-end">
                          <div className={`relative w-full rounded-md ${color}`} style={{ height: `${height}%` }}>
                            <p className={`absolute inset-x-1 top-1 text-center text-[11px] font-semibold text-white ${JOURNAL_DM_MONO}`}>{row.amount}</p>
                            <p className={`absolute inset-x-1 bottom-1 text-center text-[10px] font-semibold text-white/90 ${JOURNAL_DM_MONO}`}>{row.pct}</p>
                          </div>
            ...
            <div className="mt-4 flex justify-center">
              ...
              >
                <div className="grid h-[8.5rem] w-[8.5rem] place-items-center rounded-full bg-white shadow-[inset_0_0_0_1px_#e2e8f0]">
                  ...
                  <p className={`text-[24px] font-semibold ${HOME_TITLE_BLACK} ${JOURNAL_DM_MONO}`}>{suspiciousTotal}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="flex items-start gap-5">
              <div className="text-right">
                ...
                <p className={`text-[42px] font-semibold leading-none text-[#10b981] ${JOURNAL_DM_MONO}`}>{repaymentPeak}%</p>
              ...
              <div className="text-right">
                ...
                <p className={`text-[42px] font-semibold leading-none text-[#ef4444] ${JOURNAL_DM_MONO}`}>{repaymentCurrent}%</p>
